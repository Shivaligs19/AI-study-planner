...
const HeroSection = () => (
  <section className="relative overflow-hidden py-24 md:py-36 min-h-[90vh] flex items-center">
    ...
    <div className="container relative z-10 grid lg:grid-cols-2 gap-16 items-center animate-fade-up">
      <div className="flex flex-col items-start gap-8 text-left">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-primary font-bold text-xs tracking-[0.4em] uppercase text-primary/80">
        ...
        <div className="mt-4">
          <Button
            size="lg"
            className="h-16 px-12 text-lg font-bold uppercase tracking-widest shadow-[0_0_30px_rgba(255,0,0,0.4)] hover:shadow-[0_0_60px_rgba(255,0,0,0.6)] transition-all bg-primary hover:bg-primary/90 text-black rounded-none"
            asChild
          >
